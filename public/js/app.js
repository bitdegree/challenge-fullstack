...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getPosts: function getPosts() {
      ...
      this.isLoading = true;
      this.children = [];
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/post-children/" + this.post['id']).then(function (response) {
    ...
    deletePost: function deletePost() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/destroy/" + this.post["id"]).then(function (response) {
        _this.isLoading = false;
      });
    },
    toggleReply: function toggleReply(id) {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#" + id).fadeToggle("slow", function () {});
    },
    getDepth: function getDepth() {
      var number = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  ...
  mounted: function mounted() {
    if (this.getDepth() < 3) {
      ...
      var id = 'route-' + this.post['id'];
      var element = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#" + id);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getPosts: function getPosts() {
      var allPosts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    createPost: function createPost() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/create-post", data).then(function (response) {
        if (response.data !== 1) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex-user-container comment-min-width" }, [
    _c("div", [
      _c("img", {
        staticClass: "rounded-circle user-logo",
        attrs: { src: _vm.post["user"]["avatar"], alt: "" }
      })
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "ml-3 w-100" }, [
      _c("div", { staticClass: "row " }, [
        _c("div", { staticClass: "col-8" }, [
          _c("span", { staticClass: "font-weight-bold mb-0 mr-2" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col user-comment" }, [
        ...
        [
              ...
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.toggleReply("newPost-" + _vm.post["id"])
                  }
                }
              },
              [_vm._v("\n                Reply\n            ")]
          ...
          _c(
            "div",
            {
              ...
              attrs: { id: "newPost-" + _vm.post["id"] }
            },
            [
              _c("new-post", {
                attrs: {
                  parent: _vm.post["id"],
                  id: "newPost-" + _vm.post["id"]
                }
              })
            ],
            1
      ...
      _vm.getDepth(0) > 2
        ? _c("div", { staticClass: "row" }, [
            _c(
              ...
              {
                staticClass: "btn btn-link",
                attrs: { id: "route-" + _vm.post["id"], type: "button" },
                on: {
                  click: function($event) {
                    return _vm.getPost(_vm.post["id"])
                  }
                }
              },
              [_vm._v("\n                Load more comments\n            ")]
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row justify-content-center" }, [
      _c("div", { staticClass: "col-md-8" }, [
        _c("div", { staticClass: "card card-display container-bg mb-5" }, [
          _vm.onePost
            ? _c(
                "button",
                {
                ...
                [
                    ...
                    ? _c("div", { staticClass: "mb-5" }, [
                        _c(
                          "button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                return _vm.getPosts(true)
                              }
                            }
                          },
                          [_vm._v(_vm._s(_vm.count) + " earlier comments")]
                        )
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                  ...
                  !_vm.onePost
                    ? _c(
                        "button",
                        {
                          staticClass: "btn btn-success btn-lg btn-block mx-2",
                          attrs: { type: "button" },
                          on: {
                            click: function($event) {
                              return _vm.toggleReply("main")
                            }
                          }
                        },
                        [
                  ...
                  _c("new-post", {
                    staticClass: "mt-2",
                    staticStyle: { display: "none" },
                    attrs: { id: "main", parent: "none" }
                  })
                ],
                2
              )
            : _c("div", { staticClass: "spinner-border mx-auto my-5" }, [
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "container", attrs: { id: "newPost-" + _vm.parent } },
    [
      _c("div", { staticClass: "new-post col justify-content-center" }, [
        _c("input", {
          directives: [
            {
              name: "model",
        ...
        _vm._v(" "),
        _c("div", { staticClass: "btn-group m-2" }, [
          _c(
            "button",
            {
          ...
          _c(
            "button",
            { staticClass: "btn btn-secondary my-1", on: { click: _vm.close } },
            [_vm._v("\n                Cancel\n            ")]
          )
        ])
      ]),
